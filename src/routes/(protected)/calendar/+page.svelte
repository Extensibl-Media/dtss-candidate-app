                ...
                <div class="flex items-center gap-3 py-2">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-sm text-gray-500">
                            {selectedEvent?.extendedProps.location.city}, {selectedEvent?.extendedProps.location.state} {selectedEvent?.extendedProps.location.zip}
                        </span>
                    </div>
                </div>
            </Dialog.Description>
        ...
        {#if selectedEvent?.extendedProps.type === 'RECURRENCE_DAY'}
            <div class="space-y-6 py-4">
                ...
                <div class="space-y-3">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center gap-2 text-gray-600">
                            <Tag size={18} />
                            <Badge variant={selectedEvent.extendedProps.recurrenceDay.status === 'OPEN' ? 'default' : 'secondary'}>
                ...
                {#if selectedEvent.extendedProps.location}
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center gap-2 text-gray-600">
                            <MapPin size={18} />
                            <span>
                                {selectedEvent.extendedProps.location.name} - {selectedEvent.extendedProps.location.city},
                                {selectedEvent.extendedProps.location.state} {selectedEvent.extendedProps.location.zip}
                            </span>
                        </div>
                    </div>
                {/if}
            ...
            <Dialog.Footer class="flex gap-2 justify-end">
                ...
                <form method="POST" action="?/claimWorkdayShift" use:enhance>
                    <input type="hidden" name="recurrenceDayId" value={selectedEvent.extendedProps.recurrenceDay.id}>
                    <Button
